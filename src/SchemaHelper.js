  ...
  this._checkInputURL = function(configParams) {
    ...
    if (!configParams.inputUrl) {
      ...
      configParams.inputUrl.indexOf(
        "https://www3.gobiernodecanarias.org/istac/api/structural-resources/v1.0/codelists/ISTAC/"
      ) !== 0
    ) {
    ...
    if (error) {
      let message = "Por favor, asegúrese de que el campo URL no está vacío y que la URL tiene el siguiente formato: " +
              "https://www3.gobiernodecanarias.org/istac/api/structural-resources/v1.0/codelists/ISTAC/CL_CNAE_2009_GRUPOS_VENTA/01.000";
