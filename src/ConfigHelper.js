    ...
    if (
      ...
      if (
        ...
        config
          ...
          .setId("inputUrl")
          .setName("URL")
          .setHelpText("Esta URL debe ser una petición de la API. Por ejemplo: https://datos.canarias.es/api/estadisticas/structural-resources/v1.0/codelists/ISTAC/CL_CNAE_2009_GRUPOS_VENTA/01.000")
