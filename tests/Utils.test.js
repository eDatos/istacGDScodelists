    ...
    "code": [
        {
            ...
            "selfLink": {
                ...
                "href": "https://datos.canarias.es/api/estadisticas/structural-resources/v1.0/codelists/ESTAT/CL_AGE/2.0/codes/_T"
            },
            "name": {
                "text": [
                    {
        ...
        },
        {
            ...
            "selfLink": {
                "kind": "structuralResources#code",
                "href": "https://datos.canarias.es/api/estadisticas/structural-resources/v1.0/codelists/ESTAT/CL_AGE/2.0/codes/LFD"
            },
            "name": {
                "text": [
                    {
